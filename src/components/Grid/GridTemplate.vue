...
export default {
  ...
  methods: {
    ...
    createDashboardLayout (displayName) {
      ...
      newMobileDashboardLayoutMode.layout = [{'x': 0, 'y': 0, 'w': 2, 'h': 2, 'i': '0', 'readView': 'default', 'hybridView': 'default', 'writeView': 'default', 'template': 'none', 'customView': 'default'}]
      ...
      newDesktopDashboardLayoutMode.layout = [{'x': 0, 'y': 0, 'w': 2, 'h': 2, 'i': '1', 'readView': 'default', 'hybridView': 'default', 'writeView': 'default', 'template': 'none', 'customView': 'default'}]
    ...
    createDashboardMode (displayName) {
      ...
      // Create the standard, needed modes
      newDashboardLayoutMode.layout = [{'x': 0, 'y': 0, 'w': 2, 'h': 2, 'i': '0', 'readView': 'default', 'hybridView': 'default', 'writeView': 'default', 'template': 'none', 'customView': 'default'}]
