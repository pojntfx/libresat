...
* refactor(identity): use constants instead of strings for meta roles, give utilities more verbose nam ([c9ceafb](https://gitlab.com/libresat/libresat/commit/c9ceafb))
...
* feat(identity, service): add basic create mutations, enable unique fields ([1930f9f](https://gitlab.com/libresat/libresat/commit/1930f9f))
...
* feat(satctl): implement check for whether file exists ([36313e8](https://gitlab.com/libresat/libresat/commit/36313e8))
...
## <small>0.0.1-2 (2018-09-04)</small>
...
* Added design files from client and website ([3bdfebc](https://gitlab.com/libresat/libresat/commit/3bdfebc))
...
* Added minimal widht and height for the cards, added a "move card" button and fixed card styling ([603aac3](https://gitlab.com/libresat/libresat/commit/603aac3))
...
* Added syntax highlighting to the demo's src ([7c8d7aa](https://gitlab.com/libresat/libresat/commit/7c8d7aa))
...
* Hide cookie banner by default (we do not currently use any) ([a5db6b9](https://gitlab.com/libresat/libresat/commit/a5db6b9))
...
* Removed Route53, refactored notes ([c9ebdd2](https://gitlab.com/libresat/libresat/commit/c9ebdd2))
...
* fix(infrastructure): fix folder structure ([d74b4d5](https://gitlab.com/libresat/libresat/commit/d74b4d5))
...
* feat(gitit-docker Docs): add more detailed instructions on costumisation of the container ([0fc4321](https://gitlab.com/libresat/libresat/commit/0fc4321))
...
* feat(libresat-forum Mail Server): use build args during configuration ([a8c6079](https://gitlab.com/libresat/libresat/commit/a8c6079))
...
* feat(libresat-wiki Mailman Exim): add mailman-hyperkitty plugin ([5018167](https://gitlab.com/libresat/libresat/commit/5018167))
...
* feat(site): add masonry grid for latest posts, add icons to headers in blog ([9fb3736](https://gitlab.com/libresat/libresat/commit/9fb3736))
...
* feat(site): get post title from heading, get excerpt from gatsby-mdx ([8fdcf92](https://gitlab.com/libresat/libresat/commit/8fdcf92))
...
* refactor(libresat-forum): make standard install less error-prone ([7341818](https://gitlab.com/libresat/libresat/commit/7341818))
...
* refactor(libresat-wiki): formatting, install clang as dependency ([40c25da](https://gitlab.com/libresat/libresat/commit/40c25da))
* refactor(libresat-wiki): start implementation of run script ([50c0aa2](https://gitlab.com/libresat/libresat/commit/50c0aa2))
* refactor(libresat): improve badges and master README ([af71316](https://gitlab.com/libresat/libresat/commit/af71316))
* refactor(libresat): standardize global README ([b13a67b](https://gitlab.com/libresat/libresat/commit/b13a67b))
* refactor(libresat): start refactoring folders ([bf63f5b](https://gitlab.com/libresat/libresat/commit/bf63f5b))
* refactor(mail): distinguish between "Deployment" and "Usage" ([33c1bff](https://gitlab.com/libresat/libresat/commit/33c1bff))
* refactor(mail): standardize README, add banner image, document values ([c67be7e](https://gitlab.com/libresat/libresat/commit/c67be7e))
* refactor(site-legacy): prepare for merge into monorepo ([e4b5d96](https://gitlab.com/libresat/libresat/commit/e4b5d96))
* refactor(site): enable arbitrary amounts of statistics ([dd29e8d](https://gitlab.com/libresat/libresat/commit/dd29e8d))
* refactor(site): fetch data for hero component from data file ([2ec54eb](https://gitlab.com/libresat/libresat/commit/2ec54eb))
* refactor(site): make masonry gallery more modular and prepare for posts fetching ([414b799](https://gitlab.com/libresat/libresat/commit/414b799))
* refactor(site): prepare for merge into monorepo ([d375d53](https://gitlab.com/libresat/libresat/commit/d375d53))
* refactor(site): split search up into modular components ([959f143](https://gitlab.com/libresat/libresat/commit/959f143))
* refactor(site): start making search more maintainable ([2b7a572](https://gitlab.com/libresat/libresat/commit/2b7a572))
* refactor(site): use labelPosition for buttons where sensible ([d89412b](https://gitlab.com/libresat/libresat/commit/d89412b))
* refactor(site): use multiline strings in data files for descriptions ([e7351bc](https://gitlab.com/libresat/libresat/commit/e7351bc))
* refactor(site): use namespace from helm instead of creating namespace yaml manually ([3a3007b](https://gitlab.com/libresat/libresat/commit/3a3007b))
* refactor(site): use universal link where possible ([c87dcb7](https://gitlab.com/libresat/libresat/commit/c87dcb7))
* refactor(swarm-manager): prepare for merge into monorepo ([19ddc52](https://gitlab.com/libresat/libresat/commit/19ddc52))
* refactor(wiki-git-older): prepare for merge into monorepo ([a99ed95](https://gitlab.com/libresat/libresat/commit/a99ed95))
* refactor(wiki): improve documentation and update screenshots ([1c9fd6c](https://gitlab.com/libresat/libresat/commit/1c9fd6c))
* refactor(wiki): prepare for merge into monorepo ([161233c](https://gitlab.com/libresat/libresat/commit/161233c))
* chore(libresat): update standardized README ([c15f7c1](https://gitlab.com/libresat/libresat/commit/c15f7c1))
* chore(wiki): update screenshots ([9860954](https://gitlab.com/libresat/libresat/commit/9860954))
* add(site): enable display of both featured and regular posts using the coverflow component ([3c92668](https://gitlab.com/libresat/libresat/commit/3c92668))
* delete(legacy-repos): delete legacy repos that have been merged into the archive ([54bbbe7](https://gitlab.com/libresat/libresat/commit/54bbbe7))
* delete(site): remove Jekyll-based site to start switch to Gatsby ([2b290ef](https://gitlab.com/libresat/libresat/commit/2b290ef))
* remove(design): remove design, which has been merged into the design monorepo ([bf3e489](https://gitlab.com/libresat/libresat/commit/bf3e489))
* revert(libresat-forum): start from scratch because of breaking postfix ([6a6cbad](https://gitlab.com/libresat/libresat/commit/6a6cbad))
* reafactor(gitit-docker): rewrite docs and use more sane folder structure ([f3ef9fb](https://gitlab.com/libresat/libresat/commit/f3ef9fb))
